package com.example.harshit.locations;
         ...
         */
            ...
            sendButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   sendMessage.putExtra("sms_body","Help!! I'm stuck. My Location is:\n\n" +latd.getText().toString().substring(9)+
                           ","+longtd.getText().toString().substring(10)+"\n\n"+"Copy the above line as it is on Gmaps to find me on GMaps");
                    MainActivity.this.startActivity(sendMessage);
                }
            });
